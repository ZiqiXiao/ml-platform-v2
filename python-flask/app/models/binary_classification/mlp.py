...
class Model:
    ...
    def __init__(self, model=None, app=None, socketio=None):
        ...
        self.default_params = Config.DEFAULT_PARAMS['binary_classification']['mlp'].copy()
        self.default_params.update(Config.DEFAULT_PARAMS_UNDER['binary_classification']['mlp'])
        self.metric_data = {
            'modelName': 'mlp',
            'epoch': [],
            'trainLoss': [],
