...
class Model:
    ...
    def __init__(self, model=None, app=None, socketio=None):
        ...
        self.default_params = Config.DEFAULT_PARAMS['multiple_classification']['lg'].copy(
        )
        self.default_params.update(
            Config.DEFAULT_PARAMS_UNDER['multiple_classification']['lg'])
        self.metric_data = {
            'modelName': 'lg',
            'epoch': [],
            'trainLoss': [],
    ...
    def train(self, dataset_path, label, custom_params={}):
        ...
        self.socketio.emit('train-message', {'modelName': 'lg', 'progress': 100})
