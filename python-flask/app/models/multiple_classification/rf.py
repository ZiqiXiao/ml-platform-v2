...
class Model:
    ...
    def __init__(self, model=None, app=None, socketio=None):
        ...
        self.default_params = Config.DEFAULT_PARAMS['multiple_classification']['rf'].copy()
        self.default_params.update(Config.DEFAULT_PARAMS_UNDER['multiple_classification']['rf'])
        self.metric_data = {
            'modelName': 'rf',
            'epoch': [],
            'trainLoss': [],
