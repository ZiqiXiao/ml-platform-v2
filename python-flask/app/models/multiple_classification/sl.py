...
class Model:
    ...
    def __init__(self, model=None, app=None, socketio=None):
        ...
        self.default_params = Config.DEFAULT_PARAMS['multiple_classification']['sl'].copy(
        )
        self.default_params.update(
            Config.DEFAULT_PARAMS_UNDER['multiple_classification']['sl'])
        self.metric_data = {
            'modelName': 'sl',
            'epoch': [],
            'trainLoss': [],
    ...
    def train(self, dataset_path, label, custom_params={}):
        ...
        self.model = SuperLearner(scorer=accuracy_score, random_state=seed)
